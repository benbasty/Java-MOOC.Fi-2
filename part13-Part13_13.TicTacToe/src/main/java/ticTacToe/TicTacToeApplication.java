...
public class TicTacToeApplication extends Application {
    ...
    private Label turn; //initial value of turn
    private Button[] buttons; //creating buttons initially

    public TicTacToeApplication() {
        this.xstate = true;
        this.finished = false;
        this.turn = new Label("Turn: X"); //setting turn value to X
        this.buttons = new Button[9]; // code for 9 buttons
        for (int i = 0; i < 9; i++) { //looping through a set a values to create the 9 buttons
    ...
    public void start(Stage window) {
        ...
        // top of the BorderPane - text component that includes the information about the turn
        layout.setTop(turn);
        // GridPane that contains 9 buttons set in the middle
    ...
    //source code for creating button inside the gridpane and event handlers
